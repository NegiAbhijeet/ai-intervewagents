  ...
  return (
    <View className="flex-1 justify-center px-6 bg-white">
      ...
      <View className="mb-4">
        ...
        <View className="flex-row items-center bg-gray-100 rounded-md px-3">
          <TextInput
            placeholder="••••••••"
      ...
      <TouchableOpacity
        className="bg-gradient-to-r from-blue-400/60 to-pink-500/70 py-3 rounded-md flex-row justify-center items-center mb-4"
      ...
      <TouchableOpacity
        className="bg-white border border-gray-300 py-3 rounded-md flex-row justify-center items-center"
